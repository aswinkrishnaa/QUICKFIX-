...
if (isset($_SESSION['user_email'])) {
    ...
    if ($stmt->num_rows === 1) {
        $stmt->bind_result($userId, $currentName);
        $stmt->fetch();
...
<head>
    ...
    <style>
        ...
        .carousel-caption {
            /*            background-color: rgba(52, 152, 219, 0.7);  Carousel caption background color */
        ...
        <ul class="navbar-nav ml-auto" style="margin-right: 25px;">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="complaintsDropdown">
                    <a class="dropdown-item" href="complaint_report.php">Report Complaints</a>
                    <!-- Updated link to view_complaints.php without passing user_id in the URL -->
                    <a class="dropdown-item" href="view_complaints.php">Reported Complaints</a>
                    <a class="dropdown-item" href="complainthistory.php">Complaints History</a>
                </div>
            </li>
            <li class="nav-item">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block shadow">
                <h3>Welcome to QuickFix</h3><br>
                <h5><?php echo $currentName; ?></h5>
            </div>
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="images/pexels-tima-miroshnichenko-6195288.jpg" alt="Second slide">
            <div class="carousel-caption d-none d-md-block">
                <h5>From Leaky Faucets to Electrical Repairs – We've Got You Covered!</h5>
            </div>
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="images/woman-replaces-fine-saw-blade.jpg" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
                <h5>Your Home, Our Priority: Household Issue Resolution Experts</h5>
            </div>
        </div>
    </div>
