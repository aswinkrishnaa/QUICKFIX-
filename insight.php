...
// Fetch data from the complaints table related to the logged-in service provider
    ...
    $stmtComplaints->bind_param("i", $serviceProviderId);
...
//echo "</pre>";
    ...
    $stmtRatingsFeedback->bind_param("i", $serviceProviderId);
...
FROM complaints WHERE service_provider_id = ? AND status = 'resolved'";

$stmtResolutionTime = $conn->prepare($sqlResolutionTime);
$stmtResolutionTime->bind_param("i", $serviceProviderId);
