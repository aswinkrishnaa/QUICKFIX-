...
// Query to fetch accepted complaints based on the service provider's profession and preferred location
$sql = "SELECT c.id, c.user_id, c.issue_type, c.description, c.severity, c.submission_date,c.status
        FROM complaints c
         WHERE (c.status = 'accepted' OR c.status = 'inprogress')
...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto" style="margin-right: 25px;">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="profileDropdown" style="left:-90px">
    ...
    <center>
        <h4 style="margin-top: 100px; color: maroon;">No accepted complaints available.</h4>
    </center>
    <?php else: ?>
